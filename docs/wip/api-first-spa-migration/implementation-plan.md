...
| A4 | 本番切替済み | `#63` + Cloud env | 2026-07-20 | `FRONTEND_MODE=spa`・サーバーsmoke OK | mode=inertia |
| A5 | 完了 | なし（operation） | 2026-07-20 | `stability-a5.md`・blockingなし | mode=inertia |
| A6 | 完了 | `#69` | 2026-07-20 | Inertia削除・本番確認OK | A5 release / PR revert |
| A7 | PR作成済み | `#70` / `chore/a7-remove-frontend` | 2026-07-20 | frontend削除。merge前にRender Auto-Deploy停止 | PR revert |
| A8 | 未着手 |  |  |  | docs revert |
