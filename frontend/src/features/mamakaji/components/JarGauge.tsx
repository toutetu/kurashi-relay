...
export function JarGauge({ count, size = 106 }: JarGaugeProps) {
  const clipId = useId();
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="24" y="24" width="82" height="16" rx="8" fill="var(--mkj-rasp)" />
      <rect x="55" y="14" width="20" height="12" rx="6" fill="var(--mkj-rasp)" />
